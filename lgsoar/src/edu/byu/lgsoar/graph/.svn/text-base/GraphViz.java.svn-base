 ...
 * 
 * <dl>
 * <dt>Purpose: <a href="www.graphviz.org">GraphViz</a> Java API
 * <dd>
 *
 * <dt>Description:
...
public class GraphViz
{
   ...
   private static String DOT = Constants.getProperty("GV_DIR") + "dot.exe";
   ...
   private byte[] get_img_stream(File dot)
   {
      ...
      try {
         img = File.createTempFile("graph_", ".gif", new File(Constants.getProperty("TEMP_DIR")));
...
//         Process p = rt.exec(cmd);
         ...
         System.err.println("Error:    in I/O processing of tempfile in dir " + Constants.getProperty("TEMP_DIR")+"\n");
   ...
   private File writeDotSourceToFile(String str) throws java.io.IOException
   {
      File temp;
      try {
         temp = File.createTempFile("graph_", ".dot.tmp", new File(Constants.getProperty("TEMP_DIR")));
