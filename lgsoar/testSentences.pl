...
@sentences = (
	...
	# This is an <adj?> <noun>.
	["This is a red block.",
		"INDEF(N5) block(N2) red(N2) this(N2)",
		1],
	["This is a block.", 
	 "INDEF(N4) block(N2) this(N2)",
		1],
	["This is a ball.", 
	 "INDEF(N4) ball(N2) this(N2)",
		1],
	["That is a block.", 
		"INDEF(N4) block(N2) that(N2)",
		2],
	["This is a yellow block.", 
		"INDEF(N5) block(N2) this(N2) yellow(N2)",
		1],
	["That is a red ball.", 
		"INDEF(N5) ball(N2) red(N2) that(N2)",
		2],
	# These are <adj?> <noun>.
	...
	["Which is the yellow block?",
	  "DEF(N5) block(N2) which(N2) yellow(N2)",
		1],	
	["Which is the block?",
		"DEF(N4) block(N2) which(N2)",
		1],	
	["Which is a block?",
		"INDEF(N4) block(N2) which(N2)",
		2],	
	["Which is a green block?",
		"INDEF(N5) block(N2) green(N2) which(N2)",
		2],	
	...
	["What is the color of this?",
		"DEF(N4) color(N2) of(N4,N5) this(N5) what(N2)",
		1],	
	["What color is this?",
		"",
		2],	
	["What is the color of that?",
		"DEF(N4) color(N2) of(N4,N5) that(N5) what(N2)",
		2],	
	["What color is that?",
		"",
		2],	
	["What is the size of this?",
	 "DEF(N4) of(N4,N5) size(N2) this(N5) what(N2)",
		1],	
	["What is the shape of this?",
		"DEF(N4) of(N4,N5) shape(N2) this(N5) what(N2)",
		1],	
